    ...
    <div className="space-y-6">
      ...
      {dataPoints.length === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <ChartCard title="Battery Level" icon={Battery} delay={0.15}>
            <ResponsiveContainer width="100%" height={200}>
              <AreaChart data={dataPoints}>
                <defs>
                ...
                <Tooltip contentStyle={{ backgroundColor: "#111827", border: "1px solid #374151", borderRadius: 8 }} />
                <Area type="monotone" dataKey="battery" stroke="#10b981" fill="url(#batGrad)" strokeWidth={2} />
              </AreaChart>
            </ResponsiveContainer>
          </ChartCard>

          <ChartCard title="Rain Events" icon={CloudRain} delay={0.2}>
            <ResponsiveContainer width="100%" height={200}>
